...
type AccessPermissionResponse struct {
	...
	AccessPermission bool `protobuf:"varint,1,opt,name=AccessPermission,proto3" json:"AccessPermission,omitempty"`
}
...
func (x *AccessPermissionResponse) GetAccessPermission() bool {
	if x != nil {
